...
- 🎉 Became a contributor of [**uftrace v0.18**](https://github.com/namhyung/uftrace/releases/tag/v0.18)
- 🔌 Published [**TransparentClass**](https://plugins.jetbrains.com/plugin/28542-transparentclass) — IntelliJ IDEA plugin
- 🚀 Started [**VectorWave**](https://github.com/republicofgamja/vtm) — auto-connects programs to vector DBs
